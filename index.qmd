...
# ADD HIGHLIGHT KEYS
df_historical <- df_historical %>% highlight_key(~year)
df_2025 <- df_2025 %>% highlight_key(~year)
df_avg_historical <- df_avg_historical %>% highlight_key(~week)
...
# Add trace for 2025
if(exists("df_2025") && is.data.frame(df_2025) && nrow(df_2025) > 0) {
